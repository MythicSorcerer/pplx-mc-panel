...
// Only preferences that are actually wired to real behaviour in the app.
interface Prefs { autoScroll: boolean; timestampsInConsole: boolean; }
const DEFAULT: Prefs = { autoScroll: true, timestampsInConsole: true };
const PREF_LABELS: { key: keyof Prefs; label: string; desc: string }[] = [
  { key: "autoScroll",          label: "Auto-scroll console",   desc: "Keep console pinned to the latest output line." },
